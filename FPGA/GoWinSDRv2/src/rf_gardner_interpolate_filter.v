...
wire [14:0] data_in_Q = {data_in_Q_12[11:0],3'b000};
    ...
    // y(k) = f1*(μk)^2 + f2*uk + f3
    //f1参与的第一个乘法器,计算I路数据
    Gowin_MULT_1716  mult_interploate_f1_1_I(
    ...
    Gowin_MULT_1716  mult_interploate_f1_2_I(
    ...
    //f2参与的第一个乘法器,计算I路数据    
    Gowin_MULT_1716  mult_interploate_f2_1_I(
    ...
    //f1参与的第一个乘法器,计算Q路数据
    Gowin_MULT_1716  mult_interploate_f1_1_Q(
    ...
    Gowin_MULT_1716  mult_interploate_f1_2_Q(
    ...
    //f2参与的第一个乘法器,计算Q路数据    
    Gowin_MULT_1716  mult_interploate_f2_1_Q(
